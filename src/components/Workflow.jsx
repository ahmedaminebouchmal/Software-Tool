...
const Workflow = () => {
  return (
    <div className="mt-20 bg-shining">
      <h2 className="text-3xl sm:text-5xl lg:text-6xl text-center mt-6 tracking-wide text-primary-color">
      ...
      <div className="flex flex-wrap justify-center">
        <div className="p-2 w-full lg:w-1/2">
          <img 
            src={codeImg} 
            alt="Programmierung" 
            className="rounded-lg shadow-lg shadow-primary-color/50"
          />
        </div>
        <div className="pt-12 w-full lg:w-1/2">
          {checklistItems.map((item, index) => (
            <div key={index} className="flex mb-12">
              ...
              <div>
                <h5 className="mt-1 mb-2 text-xl text-neutral-200">{item.title}</h5>
